...
namespace xgboost
{
    ...
    public:
        ...
        JsonString(JsonString &&str) noexcept: Value(ValueKind::kString)
        {  // NOLINT
 ...
 */
    ...
    public:
        ...
        explicit JsonTypedArray(size_t n) : Value(kind)
        { vec_.resize(n); }
 ...
 */
    ...
    public:
        ...
        JsonNumber(FloatT value) : Value(ValueKind::kNumber)
        {  // NOLINT
            number_ = value;
        }
    ...
    public:
        JsonInteger() : Value(ValueKind::kInteger)
        {}  // NOLINT
        template<typename IntT,
                typename std::enable_if<std::is_same<IntT, Int>::value>::type * = nullptr>
        JsonInteger(IntT value) : Value(ValueKind::kInteger), integer_{value}
        {} // NOLINT
        template<typename IntT,
    ...
    public:
        ...
        JsonNull(std::nullptr_t) : Value(ValueKind::kNull)
        {}  // NOLINT
